            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td1.png" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Grey Polo Tshirt</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 499</h6><h6 class="text-muted ml-2"><del>Rs. 600</del></h6>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td2.png" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Stylish Printed Tshirt (Pink)</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 599</h6><h6 class="text-muted ml-2"><del>Rs. 799</del></h6>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td3.png" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Premium TechM Tshirt</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 899</h6><h6 class="text-muted ml-2"><del>Rs. 1099</del></h6>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td4.png" alt="image">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Smooth White TechM Tshirt</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 499</h6><h6 class="text-muted ml-2"><del>Rs. 699</del></h6>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class=" nested-div col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td5.png" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">  Smooth White Techm SweatShirt</h6>
                                <div class="d-flex justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td6.png" alt="image">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Smooth White TechM Tshirt with Collar</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 499</h6><h6 class="text-muted ml-2"><del>Rs. 799</del></h6>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td7.png" alt="image">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3"> Matt Black TechM Tshirt with Collar</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 499</h6><h6 class="text-muted ml-2"><del>Rs. 799</del></h6>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td8.png" alt="image">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Puma TechM Tshirt (White)</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 1299</h6><h6 class="text-muted ml-2"><del>Rs. 1999</del></h6>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                <a href="" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 nested-div">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="../UserTemplate/img/td9.png" alt="image">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Blue TechM Tshirt</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>Rs. 499</h6><h6 class="text-muted ml-2"><del>Rs. 799</del></h6>
                                </div>
                            </div>
                    ...
                    <div class="col-12 pb-1">
                        <nav aria-label="Page navigation">
                          <ul class="pagination justify-content-center mb-3">
                            ...
                            <li class="page-item active"><a class="page-link" href="Shop.aspx">1</a></li>
